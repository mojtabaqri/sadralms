        ...
        <div class="col-12 text-right" style="direction: ltr!important;">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> دوره ها تایید نشده</h4>
                </div>
